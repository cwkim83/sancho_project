...
// 쓰는 법:  node probe.js <주소> [기다릴ms=4000] [DOM저장경로]
//   예)     node probe.js http://127.0.0.1:8790/m/calendar.html 5000 out.html
...
if (!url) { console.error('쓰는 법: node probe.js <주소> [ms] [DOM저장경로]'); process.exit(2); }
